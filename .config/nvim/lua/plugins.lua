    ...
    function()
        ...
        use {
            ...
            config = function()
                ...
                wk.register({j = {"<cmd>Dic<CR>", "Dict Word", silent = true}},
                            {prefix = "<leader>"})
            end
        }
        use {
        ...
        let g:pydocstring_formatter = 'google'
                ...
                wk.register({d = {"<cmd>Pydocstring<cr>", "Python Doc String"}},
        ...
        use {"tpope/vim-abolish"} -- smart substitute (non-)captilized words
        use {"vim-scripts/CmdlineComplete"}
        use {"farmergreg/vim-lastplace"} -- saves last position of file
        use {"tpope/vim-repeat"} -- repeat operators
        use {"mg979/vim-visual-multi"} -- multiple cursors

        use {"tpope/vim-sensible"} -- universal set of defaults that (hopefully) everyone can agree on
        ...
        use {
            "hrsh7th/nvim-cmp",
            requires = {
                "hrsh7th/cmp-buffer", "hrsh7th/cmp-nvim-lsp", -- LSP source for nvim-cmp
                "saadparwaiz1/cmp_luasnip", -- Snippets source for nvim-cmp
                "L3MON4D3/LuaSnip", -- Snippets plugin
                "hrsh7th/cmp-buffer", "hrsh7th/cmp-path", "hrsh7th/cmp-cmdline",
                "hrsh7th/cmp-omni", "petertriho/cmp-git"
            },
            config = function()
        ...
        use {
            ...
            config = function()
                local wk = require("which-key")
                wk.register({s = {g = {"<cmd>Grepper<cr>", "Grepper"}}},
                            {prefix = "<leader>"})
            end
        }
        ...
        use {
            ...
            config = function()
                local wk = require("which-key")
                wk.register({a = {f = {"<cmd>Neoformat<cr>", "Format file"}}},
                            {prefix = "<leader>"})
            ...
            config = function()
                require"lualine".setup {
                    ...
                    sections = {
                        ...
                        lualine_x = {
                            require"lsp-status".status, "encoding",
                            "fileformat", "filetype"
                        },
                        lualine_y = {"progress"},
                        lualine_z = {"location"}
        ...
        use {
            ...
            config = function()
                ...
                local wk = require("which-key")
                wk.register({
                    t = {r = {"<cmd>Telescope frecency<cr>", "Frecency"}}
                }, {prefix = "<leader>"})
            end,
                ...
                require("telescope").setup({
                    defaults = {
                        ...
                        file_ignore_patterns = {
                            "node_modules", ".git/", ".vscode/", "mlruns/",
                            "tmp/"
                        }
                    },
                    extensions = {
            ...
            config = function()
                ...
                require"nvim-treesitter.configs".setup {
                    ...
                    highlight = {
                        ...
                        disable = {"rust", "org"}, -- list of language that will be disabled
        ...
        use {
            ...
            config = function()
                local wk = require("which-key")
                wk.register({
                    a = {s = {"<Plug>GenerateDiagram ", "Swagger preview"}}
                }, {prefix = "<leader>"})
            end
        }
        --use {
        ...
        use {"iamcco/markdown-preview.nvim", config = function() end}
        use {
