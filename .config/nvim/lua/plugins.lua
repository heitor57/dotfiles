            ...
            use {
                ...
                config = function()
                    ...
                    require "nvim-treesitter.configs".setup {
                        ensure_installed = {'org',"norg", "norg_meta", "norg_table", "haskell", "cpp", "c", "javascript", "markdown"}, -- one of "all", "maintained" (parsers with maintainers), or a list of languages
...
colorscheme wpgtk
            ...
            --end}
            use {'nvim-orgmode/orgmode',requires='nvim-treesitter/nvim-treesitter', config = function()

            require('orgmode').setup({
              org_agenda_files = {'~/Dropbox/Documents/Tasks/'},
              org_default_notes_file = '~/Dropbox/Documents/Tasks/Tarefas.org',
